...
from spec2json.parsers import WattsiParser
...
def test_wattsi_parser__numbering_style_for_level(level, expected):
    assert WattsiParser.numbering_style_for_level(level) == expected
